...
Mainwin::Mainwin() : shelter{new Shelter{"Mavs Animal Shelter"}} {
    ...
    Gtk::MenuItem *menuitem_newanimal = Gtk::manage(new Gtk::MenuItem("_New Dog", true));
    menuitem_newanimal->signal_activate().connect([this] {this->on_new_animal_click();});
    animalmenu->append(*menuitem_newanimal);

    //           N E W   C A T
    // Append New to the Animal menu
    Gtk::MenuItem *menuitem_newcat = Gtk::manage(new Gtk::MenuItem("_New Cat", true));
    menuitem_newcat->signal_activate().connect([this] {this->on_new_cat_click();});
    animalmenu->append(*menuitem_newcat);

    //           N E W   R A B B I T
    // Append New to the Animal menu
    Gtk::MenuItem *menuitem_newrabbit = Gtk::manage(new Gtk::MenuItem("_New Rabbit", true));
