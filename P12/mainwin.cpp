...
Mainwin::Mainwin() : shelter{new Shelter{"Mavs Animal Shelter"}} {
    ...
    menuitem_save_as->signal_activate().connect([this] {this->on_save_click();});
...
void Mainwin::on_about_click() {
    ...
    dialog.set_program_name("CSE1325 Animal Shelter");
    auto logo = Gdk::Pixbuf::create_from_file("stock_cat.jpg");
    dialog.set_logo(logo);
    dialog.set_version("Version 5.4.0");
    dialog.set_copyright("Copyright 2019");
    dialog.set_license_type(Gtk::License::LICENSE_GPL_3_0);
    std::vector< Glib::ustring > authors = {"Daniel Vargas", "George F. Rice"};
    dialog.set_authors(authors);
    std::vector< Glib::ustring > artists = {
        "All image rights belong to Getty Images",
        };
    dialog.set_comments("This software can be used by animal shelters to maintain and organize their animals and clients.\nThis software can also be used by a chain of animals shelters to index and keep track of individual shelters and their coresponding animals and clients.");
...
void Mainwin::on_new_shelter_click() {
    status("");
    Gtk::Dialog dialog{"New Shelter Information", *this};
    ...
    dialog.add_button("New Shelter", 1);
    ...
    while(dialog.run()) {
        ...
        Shelter* shelter = new Shelter{e_name.get_text()};
    };
}
